...
with app.app_context():
    ...
    if Professional.query.first() is None:
        ...
        prof2=Professional(email="prof2@gmail.com",password="prof123",name="Jane Smith",address="456 Elm St",mobile="9876543210",experiance="3 years",status="Registered",resume_url="https://example.com/resume2.pdf")
        db.session.add(prof1)
        db.session.add(prof2)
    if Customer.query.first() is None:
        cust1=Customer(email="cust1@gmail.com",password="cust123",name="Alice Brown", status="Active", address="789 Oak St",mobile="5555555555")
        cust2=Customer(email="cust2@gmail.com",password="cust123",name="Bob Green",status="Flagged", address="321 Pine St",mobile="4444444444")
